...
class Herbarium extends Model
{
    ...
    {
        return $this->belongsTo(Collector::class, 'collector1_id');
    }

    public function getDisplayCollector1Attribute()
    {
        return optional($this->collector1)->name . ' ' . optional($this->collector1)->surname;
    }
    ...
    */
    ...
    {
        return $this->belongsTo(Collector::class, 'collector2_id');
    }

    public function getDisplayCollector2Attribute()
    {
        return optional($this->collector2)->name . ' ' . optional($this->collector2)->surname;
    ...
    public function collector3(): BelongsTo
    {
        ...
        return $this->belongsTo(Collector::class, 'collector3_id');
    }

    public function getDisplayCollector3Attribute()
    {
        return optional($this->collector3)->name . ' ' . optional($this->collector3)->surname;
        /*
